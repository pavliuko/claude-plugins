...
| [`english`](plugins/english/README.md) | `UserPromptSubmit` hook that injects an English-coaching brief so Claude appends a short ❌/✅ correction when your prompt has a real mistake. |
